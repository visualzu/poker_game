...
HD_PWD='D:/FPGA/POKE_V5/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_to_poker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_to_poker.tcl
