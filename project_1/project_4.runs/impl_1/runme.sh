...
HD_PWD='D:/FPGA/POKE_V5/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_to_poker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_to_poker.tcl -notrace
